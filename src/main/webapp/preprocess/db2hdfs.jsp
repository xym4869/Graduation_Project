...
<body>
<div style="padding-left: 30px;font-size: 20px;padding-top:10px;">数据过滤</div>

<div style="padding-left: 30px;font-size: 15px;padding-top:10px;"><br>
    结果数据过滤处理包括：<br>
    <ol>
        <li>过滤结果数据中符合规则的数据</li>
        <li>过滤规则 ：存在域名关键字且设备信息不全为空</li>
        <li>把符合规则的LogData数据写入HDFS</li>
    </ol>
</div>
<br>
<div style="padding-left: 30px;font-size: 20px;padding-top:10px;">
    <table>
        ...
        <tr>
            <td><%--@declare id="name"--%><label for="name">输出路径:</label>
            </td>
            <td><input class="easyui-validatebox" type="text"
