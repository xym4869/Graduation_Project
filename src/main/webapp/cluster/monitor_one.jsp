<%@ page language="java" import="java.util.*" pageEncoding="UTF-8"%>
  ...
  <div  data-options="region:'north',border:false" style="height:60px;padding:50px 50px 10px 50px;">
 	 <h1 style="font-size: larger;text-align: center"> Hadoop集群任务实时监控</h1><br><hr><br>
  </div>
  <div style="padding-left: 35%;padding-top:10px;">
	 <table>
			 <tr>
				<td><%--@declare id="name"--%><label for="name" style="font-size:13px">所有任务个数:</label></td>
				...
				<tr>
				<td><label for="name" style="font-size:13px">当前任务:</label></td>
				<td><input class="easyui-validatebox" type="text"
   		...
   		<tr>
				<td><label for="name" style="font-size:13px">JobID:</label></td>
				<td><input class="easyui-validatebox" type="text"
				...
				<tr>
					<td><label for="name" style="font-size:13px">JobName:</label></td>
					<td><input class="easyui-validatebox" type="text"
				...
				<tr>
					<td><label for="name" style="font-size:13px">Map进度:</label></td>
					<td><input class="easyui-validatebox" type="text"
				...
				<tr>
					<td><label for="name" style="font-size:13px">Reduce进度:</label></td>
					<td><input class="easyui-validatebox" type="text"
				...
				<tr>
					<td><label for="name" style="font-size:13px">任务执行状态:</label></td>
					<td><input class="easyui-validatebox" type="text"
